...
public class ProductSell {
    ...
    public ProductSell(Integer productid, Double month1, Double month2, Double month3, Double month4, Double month5, Double month6, Double month7, Double month8, Double month9, Double month10, Double month11, Double month12, String skucode, String cnname, String warehousename, String imgurl) {
    ...
    public ProductSell(Integer productid, Double month1, Double month2, Double month3, Double month4, Double month5, Double month6, Double month7, Double month8, Double month9, Double month10, Double month11, Double month12) {
        this.productid = productid;
        this.month1 = month1;
        this.month2 = month2;
        this.month3 = month3;
