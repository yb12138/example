...
import com.heeexy.example.dao.SysUserMapper;
import com.heeexy.example.model.SysUser;
import com.heeexy.example.model.SysUserExample;
...
public class UserController {
    ...
    public JSONObject listWarehouse() {
        ...
        example.createCriteria().andRoleIdEqualTo(4);
        List<SysUser> sysUsers = sysUserMapper.selectByExample(example);
        return CommonUtil.successJson(sysUsers);
    }
